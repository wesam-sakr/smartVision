...
function slick(){
    ...
    $("#workSlider").slick({slidesToShow: 1,centerMode: true,centerPadding: '260px',
    ...
    $("#screens").slick({slidesToShow: 1,centerMode: true,centerPadding: '260px',
