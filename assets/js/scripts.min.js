...
function slick() {
  ...
  $("#workSlider").slick({
    slidesToShow: 1, centerMode: true, centerPadding: '260px',
    variableWidth: true, arrows: !0, rtl: !1,
    responsive: [{ breakpoint: 1200, settings: { arrows: !0, centerMode: true, centerPadding: "60px", slidesToShow: 3 } }, { breakpoint: 991, settings: { arrows: !0, centerMode: true, centerPadding: "200px", slidesToShow: 1 } }, { breakpoint: 768, settings: { arrows: !0, centerMode: false, centerPadding: "0px", slidesToShow: 1 } }]
  }),
    $("#workSlider").length && $("#screens").slick("slickSetOption", "rtl", "rtl" === getCookie("textDirection"))

  $("#screens").slick({
    slidesToShow: 1, centerMode: true, centerPadding: '260px',
    variableWidth: true, arrows: false, dots: true, rtl: !1,
    // responsive:[{breakpoint:1200,settings:{arrows:!0,centerMode:true,centerPadding:"60px",slidesToShow:3}},{breakpoint:991,settings:{arrows:!0,centerMode:true,centerPadding:"200px",slidesToShow:1}},{breakpoint:768,settings:{arrows:!0,centerMode:true,centerPadding:"50px",slidesToShow:1}},{breakpoint:590,settings:"unslick"}]
  }),
    $("#screens").length && $("#screens").slick("slickSetOption", "rtl", "rtl" === getCookie("textDirection"))
  $('.clients').slick({
    dots: false,
    infinite: true,
    speed: 300,
...
function popup() {
   $(".popup-with-form").length && $(".popup-with-form").magnificPopup({ 
    ...
    focus: "#name", 
    closeOnBgClick: !0, 
    callbacks: { beforeOpen: function () { 700 > $(window).width() ? this.st.focus = !1 : this.st.focus = "#name" } } }), 
      ...
      gallery: { 
        ...
        $(".image-link").magnificPopup({ 
          ...
          gallery: { enabled: !0, navigateByImgClick: !0, preload: [0, 1] },
           image: { titleSrc: "title" }, calc: { enabled: !0, navigateByImgClick: !0, duration: 300, easing: "ease-in-out", 
           opener: function (t) { 
          ...
          function misc() { 
            ...
            document.addEventListener("DOMContentLoaded", function () { 
              "use strict"; 
              loadWindowSettings(), loadWindowEvents(), loadMenu(), loadTabs(), izotope(), popup(), accordion(), loadTooltips(), initSliderUI(), loadCountdown(), speacialCount(), loadSkills(), misc(), slick(), listenSlick(), loader(), backtotop(), isotope(), livechat(), contactform(), popover(), scrollgoto(), active(), display(), switching(), headerfooter(), translate(), switchVisible(), sticky(), changeColorStyle() 
            }), 
            body = $("body"), 
            antlerSettings.prototype.manageSettings = function () { 
              switch (this.showSettings) { 
                case "hide": break; case "show": settings() } 
              }, 
              antlerSettings.prototype.manageTextDirection = function () { 
                switch (this.textDirection) { 
                  case "ltr": setCookie("textDirection", "ltr", 365), body.attr("data-textDirection", "ltr"); break; case "rtl": $("html").attr("dir", "rtl"), $(function () { $("link.rtl").attr("disabled", !1) 
                }), 
                $(function () { 
